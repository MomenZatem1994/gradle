...
import static org.gradle.internal.deprecation.DeprecationMessageBuilder.createDeprecationIdString;
        ...
        Problem problem = reporter.create(new Action<InternalProblemSpec>() {
            ...
            public void execute(InternalProblemSpec builder) {
                InternalProblemSpec problemSpec = builder
                    ...
                    .id(createDeprecationIdString(usage.getProblemIdDisplayName()), usage.getProblemIdDisplayName())
